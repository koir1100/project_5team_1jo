...
urlpatterns = [
    ...
    path("list/<int:drcode>/search/", views.list_search, name="list-specific-keyword-default"),
    path("list/<int:drcode>/search/<str:keyword>", views.list_search, name="list-specific-keyword"),
